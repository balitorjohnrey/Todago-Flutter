...
class _PassengerHomeScreenState extends State<PassengerHomeScreen> {
  ...
  final List<Map<String, dynamic>> _upcoming = [
    {
      'date': 'March 22, 2026', 'time': '08:00 AM',
      'pickup': 'DNSC', 'destination': 'Night Market',
      'driver': 'Juan Reyes', 'type': 'Solo', 'fare': '₱20',
      'status': 'Confirmed', 'statusColor': Colors.green,
    },
    {
      'date': 'March 23, 2026', 'time': '08:00 AM',
  ...
  final List<Map<String, dynamic>> _past = [
    {
      'date': 'March 20, 2026', 'time': '07:30 AM',
      'pickup': 'Home', 'destination': 'DNSC',
      'driver': 'Pedro Lopez', 'type': 'Solo', 'fare': '₱25',
      'status': 'Completed', 'statusColor': Colors.grey, 'rating': 5,
    },
    {
      'date': 'March 18, 2026', 'time': '05:00 PM',
      'pickup': 'Panabo Market', 'destination': 'DNSC',
      'driver': 'Maria Santos', 'type': 'Shared', 'fare': '₱15',
      'status': 'Completed', 'statusColor': Colors.grey, 'rating': 4,
    },
    {
      'date': 'March 15, 2026', 'time': '08:00 AM',
      'pickup': 'DNSC', 'destination': 'Panabo Bus Terminal',
      'driver': 'Jose Cruz', 'type': 'Solo', 'fare': '₱20',
      'status': 'Cancelled', 'statusColor': Colors.red, 'rating': null,
    },
  ];
  ...
  final List<Map<String, dynamic>> _transactions = [
    {
      'type': 'trip', 'title': 'Solo Ride — Night Market',
      'subtitle': 'Paid to Juan Reyes',
      'date': 'Mar 22, 2026', 'time': '08:14 AM',
      'amount': -20.00, 'icon': Icons.electric_rickshaw_rounded,
    },
    {
      'type': 'topup', 'title': 'GCash Top-up',
      'subtitle': 'via GCash ••••4821',
      'date': 'Mar 21, 2026', 'time': '10:30 AM',
      'amount': 100.00, 'icon': Icons.add_circle_rounded,
    },
    {
      'type': 'trip', 'title': 'Shared Ride — DNSC',
      'subtitle': 'Paid to Maria Santos',
      'date': 'Mar 18, 2026', 'time': '05:12 PM',
      'amount': -15.00, 'icon': Icons.electric_rickshaw_rounded,
    },
    {
      'type': 'cashback', 'title': 'Ride Cashback',
      'subtitle': 'TodaGo Rewards',
      'date': 'Mar 10, 2026', 'time': '09:01 AM',
      'amount': 5.00, 'icon': Icons.card_giftcard_rounded,
    },
    {
      'type': 'topup', 'title': 'Maya Top-up',
      'subtitle': 'via Maya Wallet',
      'date': 'Mar 10, 2026', 'time': '09:00 AM',
      'amount': 200.00, 'icon': Icons.add_circle_rounded,
    },
    {
      'type': 'trip', 'title': 'Toda-Express — Airport',
      'subtitle': 'Paid to Pedro Lopez',
      'date': 'Mar 5, 2026', 'time': '04:00 AM',
      'amount': -90.00, 'icon': Icons.electric_rickshaw_rounded,
    },
  ];
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('Destination', style: GoogleFonts.poppins(fontSize: 10, color: AppColors.textHint)),
          ...
          Row(children: [
            ...
            const Spacer(),
            Text('${b['type']}  ', style: GoogleFonts.poppins(fontSize: 12, color: AppColors.textHint)),
            Text(b['fare'] as String, style: GoogleFonts.poppins(
              fontSize: 15, fontWeight: FontWeight.w800, color: AppColors.backgroundDark,
            )),
          ]),
            ...
            Row(children: [
              ...
              Expanded(child: ElevatedButton(
                onPressed: () => Navigator.of(context).push(
                  PageRouteBuilder(
                    pageBuilder: (_, __, ___) => const LiveTripTrackingScreen(),
                    transitionDuration: const Duration(milliseconds: 400),
  ...
  Widget _emptyBookings() => Center(child: Column(
    ...
    children: [
      Container(
        ...
        decoration: BoxDecoration(color: const Color(0xFFF5F5F5),
            borderRadius: BorderRadius.circular(20)),
        child: const Icon(Icons.calendar_today_rounded, size: 32, color: AppColors.textHint),
      ),
      const SizedBox(height: 16),
            ...
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                  Text(
                    _balanceVisible ? '₱${_balance.toStringAsFixed(2)}' : '₱•••••',
                    style: GoogleFonts.poppins(
  ...
  Widget _wStat(String label, String val, IconData icon, {Color color = AppColors.backgroundDark}) =>
  ...
  Widget _linkedAcc(String emoji, String name, String detail, String action, bool connected) =>
    Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(name, style: GoogleFonts.poppins(
            fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.backgroundDark,
          )),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: connected ? AppColors.success.withOpacity(0.1) : AppColors.primary.withOpacity(0.1),
            borderRadius: BorderRadius.circular(20),
          ),
    ...
    child: Row(children: [
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(value, style: GoogleFonts.poppins(
          fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.backgroundDark,
        )),
      ]),
    ]),
  );
