...
class _DriverRegistrationScreenState extends State<DriverRegistrationScreen> {
  ...
  @override
  void dispose() {
    _fullNameCtrl.dispose(); _mobileCtrl.dispose(); _emailCtrl.dispose();
    _todaBranchCtrl.dispose(); _bodyNumberCtrl.dispose();
    _plateCtrl.dispose(); _colorCtrl.dispose(); _licenseCtrl.dispose();
  ...
  Future<void> _completeRegistration() async {
    if (_bodyNumberCtrl.text.isEmpty || _plateCtrl.text.isEmpty || _licenseCtrl.text.isEmpty) {
    ...
    if (result.success) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Row(children: [
          ...
          Expanded(child: Text(result.message ?? 'Registration submitted!',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('Driver Registration', style: GoogleFonts.poppins(
                ...
                Row(children: List.generate(3, (i) => Expanded(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: i <= _currentStep ? AppColors.primary : AppColors.surface,
        ...
        // Important notice banner — NO password needed
        Container(
          ...
          child: Row(children: [
            ...
            Expanded(child: Text(
              ...
              style: GoogleFonts.poppins(fontSize: 11, color: AppColors.backgroundDark,
  ...
  Widget _buildStep1() => SingleChildScrollView(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Text('Tell us about yourself', style: GoogleFonts.poppins(
        fontSize: 13, color: Colors.grey[500],
      )),
      const SizedBox(height: 24),
      _lbl('Full Name', required: true),
      const SizedBox(height: 6),
      _fld(controller: _fullNameCtrl, hint: 'Juan Dela Cruz',
      ...
      Text('Must match your main TodaGo account phone number',
          style: GoogleFonts.poppins(fontSize: 11, color: AppColors.primary)),
      const SizedBox(height: 18),
      _lbl('Email Address'),
      const SizedBox(height: 6),
      _fld(controller: _emailCtrl, hint: 'juan.delacruz@email.com',
  ...
  Widget _buildStep2() => SingleChildScrollView(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      const SizedBox(height: 8),
      Text('TODA Association', style: GoogleFonts.poppins(
        fontSize: 20, fontWeight: FontWeight.w800, color: AppColors.backgroundDark,
      )),
      Text('Your official TODA registration details', style: GoogleFonts.poppins(
        fontSize: 13, color: Colors.grey[500],
      )),
      const SizedBox(height: 24),
      _lbl('TODA Branch', required: true),
      const SizedBox(height: 6),
      _fld(controller: _todaBranchCtrl, hint: 'Panabo City TODA',
      ...
      Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            const SizedBox(width: 8),
            Text('TODA Certification Benefits', style: GoogleFonts.poppins(
          ...
          _benefit('Lower commission rates (10% vs 15% for non-TODA)'),
        ]),
      ),
      const SizedBox(height: 28),
      _continueBtn(_nextStep),
  ...
  Widget _buildStep3() => SingleChildScrollView(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      const SizedBox(height: 8),
      Text('Vehicle Details', style: GoogleFonts.poppins(
        fontSize: 20, fontWeight: FontWeight.w800, color: AppColors.backgroundDark,
      )),
      Text('Your tricycle registration information', style: GoogleFonts.poppins(
        fontSize: 13, color: Colors.grey[500],
      )),
      const SizedBox(height: 24),
      _lbl('License Number', required: true),
      const SizedBox(height: 6),
      _fld(controller: _licenseCtrl, hint: 'N01-23-456789',
          icon: Icons.badge_outlined),
      const SizedBox(height: 18),
      _lbl('TODA Body Number', required: true),
      const SizedBox(height: 6),
      _fld(controller: _bodyNumberCtrl, hint: 'Panabo TODA #123',
      ...
      const SizedBox(height: 6),
      _fld(controller: _plateCtrl, hint: 'ABC 1234',
          icon: Icons.document_scanner_outlined),
      const SizedBox(height: 18),
      _lbl('Vehicle Color'),
      const SizedBox(height: 6),
      _fld(controller: _colorCtrl, hint: 'Blue and Yellow',
      ...
      Container(
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('You will log in using your main TodaGo account password.',
      ...
      SizedBox(
        ...
        child: ElevatedButton(
          ...
          child: _isLoading
              ...
              : Text('Complete Registration', style: GoogleFonts.poppins(
