...
class _DriverSelectionScreenState extends State<DriverSelectionScreen> {
  ...
  Future<void> _confirmDriver() async {
    ...
    final result = await TripService.requestRide(
      ...
      serviceType: widget.serviceType.toLowerCase().replaceAll('-', '').replaceAll(' ', ''),
    ...
    if (result['success'] == true) {
      Navigator.of(context).pushReplacement(PageRouteBuilder(
        pageBuilder: (_, __, ___) => LiveTripTrackingScreen(
          ...
          driverName: _selectedDriver['driver_name'] ?? 'Driver',
          driverRating: (_selectedDriver['avg_rating'] ?? 0.0).toDouble(),
          todaBodyNumber: _selectedDriver['toda_body_number'] ?? '',
          plateNo: _selectedDriver['plate_no'] ?? '',
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(result['message'] ?? 'Driver unavailable. Choose another.',
          ...
          child: Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    final name = d['driver_name'] ?? 'Driver';
                    ...
                    final assoc  = d['association_code'] ?? d['toda_body_number'] ?? '';
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        duration: 400.ms).slideX(begin: 0.1, end: 0);
                  },
                ),
              ),
              ...
              Container(
                ...
                child: Column(children: [
                  _summaryRow('Driver', _selectedDriver['driver_name'] ?? 'Driver'),
                  const SizedBox(height: 6),
                  _summaryRow('Service Type', widget.serviceType),
                  const SizedBox(height: 6),
                  _summaryRow('ETA',
                      '${_selectedDriver['eta_minutes'] ?? 5} min away'),
                  const Padding(
