...
class _OperatorDriversScreenState extends State<OperatorDriversScreen> {
  ...
  final List<Map<String, dynamic>> _drivers = List.generate(
      12,
      (i) => {
  ...
  List<Map<String, dynamic>> get _filtered {
    ...
    if (_filterTab == 2)
      list = list.where((d) => d['status'] == 'offline').toList();
      ...
      body: Column(children: [
              ...
              return Container(
                ...
                child: Row(children: [
                  ...
                  Expanded(
                    ...
                    delay: Duration(milliseconds: 30 * i), duration: 300.ms),
              );
            },
          ),
        ),
        ...
        Container(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 8),
            _footerBadge(
                '${_drivers.where((d) => d['status'] == 'offline').length} Offline',
                Colors.grey),
          ]),
        ),
      ]),
