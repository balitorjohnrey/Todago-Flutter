          ...
          child: SafeArea(
            ...
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('Driver Login', style: GoogleFonts.poppins(
                  fontSize: 26, fontWeight: FontWeight.w800, color: Colors.white,
                )),
                Text('Welcome back, partner!', style: GoogleFonts.poppins(
        ...
        Expanded(child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              _field(controller: _bodyNumberCtrl, hint: 'Enter your TODA body number',
                icon: Icons.tag_rounded,
                suffixIcon: const Icon(Icons.info_outline_rounded, color: Colors.grey, size: 18),
                validator: (v) => v == null || v.isEmpty ? 'TODA body number is required' : null),
              ...
              const SizedBox(height: 6),
              _field(controller: _plateCtrl, hint: 'ABC 1234',
              ...
              Container(
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('First time?', style: GoogleFonts.poppins(
                    ...
                    GestureDetector(
                      ...
                      child: Text('Register as Driver →', style: GoogleFonts.poppins(
              ...
              const SizedBox(height: 24),
              Center(child: Text('By logging in, you agree to our Terms of Service',
                  style: GoogleFonts.poppins(fontSize: 11, color: Colors.grey[400]))),
              const SizedBox(height: 24),
            ]),
          ),
