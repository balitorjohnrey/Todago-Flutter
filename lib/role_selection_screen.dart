        ...
        child: SingleChildScrollView(
          ...
          child: Column(children: [
            ...
            ClipRRect(
              ...
              child: Image.asset('assets/logo.png', width: 64, height: 64, fit: BoxFit.cover),
            ...
            ...List.generate(_roles.length, (i) {
              ...
              return Padding(
                ...
                child: _RoleCard(
                  role: role, isSelected: isSelected,
                  onTap: () => setState(() => _selectedRole = role['id']),
                ).animate()
                    .fadeIn(delay: Duration(milliseconds: 250 + i * 100), duration: 400.ms)
            ...
            Column(children: [
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('LTFRB Compliant Transport Service',
                    style: GoogleFonts.poppins(
                        fontSize: 11, color: AppColors.textHint)),
              ]),
              const SizedBox(height: 4),
              Text('TodaGo v1.0.0 • Serving Local Communities',
                  style: GoogleFonts.poppins(
                      fontSize: 11, color: AppColors.textHint)),
      ...
      child: AnimatedContainer(
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(role['title'] as String, style: GoogleFonts.poppins(
              fontSize: 15, fontWeight: FontWeight.w700, color: AppColors.textPrimary,
            )),
            const SizedBox(height: 2),
            Text(role['subtitle'] as String, style: GoogleFonts.poppins(
              fontSize: 12, color: AppColors.textSecondary)),
            const SizedBox(height: 8),
            Wrap(
              spacing: 6, runSpacing: 4,
              children: (role['tags'] as List<String>).map((tag) => Container(
