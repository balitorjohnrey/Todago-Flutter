...
class _RideRequestScreenState extends State<RideRequestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final dynamic _rawFare = widget.trip['fare'];
    final fare = _rawFare == null ? 25.0 :
        _rawFare is double ? _rawFare :
        _rawFare is int ? _rawFare.toDouble() :
        double.tryParse(_rawFare.toString()) ?? 25.0;
