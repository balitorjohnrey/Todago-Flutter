...
class _RideRequestScreenState extends State<RideRequestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // ── FIX: Constrain total height so the dialog never exceeds the screen.
    // Without this, the content Column overflows on small devices and the
    // entire dialog becomes invisible even though the barrier is visible.
                        ...
                        Container(
                          ...
                          child: Column(children: [
                            ...
                            _fareRow('TodaGo Commission (flat)',
                                '- ₱${commissionAmt.toStringAsFixed(2)}',
                                AppColors.error),
                            const Padding(
