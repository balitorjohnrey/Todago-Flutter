...
class OperatorFinancialsScreen extends StatefulWidget {
  ...
  @override
  State<OperatorFinancialsScreen> createState() =>
      _OperatorFinancialsScreenState();
}
...
class _OperatorFinancialsScreenState extends State<OperatorFinancialsScreen> {
                      ...
                      GestureDetector(
                        onTap: () =>
                          ...
                          pageBuilder: (_, __, ___) =>
                              const OperatorPayCommissionScreen(),
                ...
                return Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        _txRow('Gross Revenue',
                            '₱${(t['gross'] as double).toStringAsFixed(0).replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (m) => '${m[1]},')}'),
  ...
  Widget _txRow(String label, String value,
          {bool isNeg = false, bool isBold = false}) =>
      Padding(
